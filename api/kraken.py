...
class Kraken(object):
    ...
    # api_key = "jH7cEtEN8+gLEOFVt/8U8CdWTezNuida7jiL3JUbBiTcz6RFTTqF32v0"    
    # api_sec = "jipFE9uK9OBLC5PyWhpHkQPVMkrXRrzCITl3pv0dLl85lAxx0IR1wTqhAZNDfp3aKkRPmyLHIIkbj7IDNs8hgA=="
    api_key = None
    api_sec = None
